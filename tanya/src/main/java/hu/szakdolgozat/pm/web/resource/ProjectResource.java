...
import hu.szakdolgozat.pm.service.ProjectService;
...
public class ProjectResource {
	...
	@PutMapping("/project")
	public ResponseEntity<ProjectDTO> create(@RequestBody @Valid ProjectEditerDTO dto) {
		return ResponseEntity.ok().body(projectService.save(dto));
	}

	@PostMapping("/project")
	public ResponseEntity<ProjectDTO> update(@RequestBody @Valid ProjectEditerDTO dto) {
